...
> For obvious reasons, many workplace documents are protected or private. For example, patients are protected by HIPAA, which means their records and information are protected from disclosure. Recent police reports, PSIRs, or forensic reports may technically be part of the public record, but that doesn't mean they're easily findable on the internet. Engineering and scientific firms often keep proprietary information closely private and protected. While I would not simply say "give up looking," if you're not networked with a professional or have professional experience as an employee, volunteer, or intern, these kinds of private, confidential, or proprietary documents will be very difficult to get hold of. Thankfully, there are many other places you could look--if you're stuck in this area, contact Dr. Andrews and he'll help you out!
...
## Option 2: Deep Dive on three examples of tactical technical communication
In this option you will explore technical communication "as a broad human activity used to effect change in the world" (Kimball 2017, p 347), specifically technical communication created **voluntarily by users** (what Kimball calls *tactical technical communication*). Your goal here is to understand the ways people use and create technical communication in their everyday lives.

Think about the various activities you do, personal hobbies you have, or things that you're just kind of nerdy about: cooking, fishing, gardening, parenting, woodworking, Skyrim, motorcycle repair, low-impact camping, or a whole host of activist and advocacy activities. After you've decided on the activity you're going to explore, you will need to **locate three (or more) [user-created documents](weekly/tactical-tech-comm) centered around that activity**.

> (For example, since I own a Shopsmith woodworking system, I might use the Shopsmith subreddit, an online discussion forum, and this user-written "Buying a used Shopsmith" manual, which are all user-generated technical discussions of the tool, or "tactical" technical communication. I would *not* use the official Shopsmith manual or offical Shopsmith Facebook page--these are examples of institutional, or strategic technical communication. <a href="weekly/tactical-tech-comm">Read more about tactical versus strategic technical communication.</a>
