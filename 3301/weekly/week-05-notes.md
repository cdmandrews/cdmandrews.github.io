...
Here's your prompt:
1. Pick a complex word or phrase that you've learned about in one of your other classes, preferably a highly specialized concept from your major. The harder, the better! Use the Up-Goer Five Text Editor at [https://splasho.com/upgoer5/](https://splasho.com/upgoer5/) to write an explanation of that concept, using ONLY the words it permits you to. Copy and paste your explanation and post it as a reply on this thread.
