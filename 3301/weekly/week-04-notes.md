...
1. Each week, as we discuss and read about document design, writing styles, and visual components, you'll apply those practices in short exercises, just as we have been doing.
2. You'll also begin working on the first major project: [A fact sheet about writing in your field](https://cdmandrews.github.io/3301/project-1). Your fact sheets are due during Week 08, and we will have collaborative discussions and peer review sessions over the next few weeks to help you understand the task and get feedback from your group on your project.

Please review the [project instructions](https://cdmandrews.github.io/3301/project-1) now, and ask me questions early and often.
...
Complete the <mark>2.1 Document design and being reader-centered</mark> thread in the "Module 2 forum: Elements of Technical and Professional Writing" before 5:00 on Tuesday.

Good document design helps your intended audience locate the information they need quickly and effectively. As you may realize from reading the assigned material for this week, designing uncluttered pages that are easy to read is not as simple as it might sound. Because of all of the bells and whistles in our word processors, it's very easy to create documents that might be ineffective.

For this post, evaluate the [City of Corpus Christi 2017 Hurricane Readiness handout](media/hurricane-prepardness-information.pdf) Suggest specific revisions for improving any problem areas you discover. Use at least 5 of the following points in your discussion, all of which are described in your readings.
...
In your own post, use descriptive, distinctive headings to help readers scan and locate information. Please post the text of your response directly to the forum text box. Do not upload a separate document for this one.

Later this week, respond to at least three other people in your group. What is your overall sense of why the document was designed in that way? Why would some of the suggested changes make it better?

## For Thursday

Participate in the <mark>"Q&A and fact sheet genre"</mark> discussion thread in your group before 5:00 pm on Thursday.
...
2. Individually analyze your two fact sheets. In the discussion forum, post a SHORT summary of  the following information (nested lists or a table would seem to work best for this, but you don't have to upload a separate document):
